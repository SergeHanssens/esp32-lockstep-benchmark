...
| `verify_coremark_sources.ps1` | MD5-check CoreMark-bronnen t.o.v. EEMBC upstream `1f483d5` | `-BronMap`, `-RefBestand`; hashes in `coremark_md5_upstream_1f483d5.txt` |
| `build_flash_capture_05.ps1` / `_06.ps1` / `flash_capture_new3.ps1` / `build_flash_capture_03oneway.ps1` | build + flash + capture per project | paden bovenaan het script (labspoor, bewust eenvoudig) |
